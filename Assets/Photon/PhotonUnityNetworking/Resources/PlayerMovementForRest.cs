...
public class PlayerMovementForRest : MonoBehaviourPunCallbacks
{
    ...
    [HideInInspector] public bool wallrunning; // Solamente lo usara el script "WallRun"
    ...
    private void Update()
    {
        if (photonView.IsMine && !wallrunning)
        {
            // Movimiento
